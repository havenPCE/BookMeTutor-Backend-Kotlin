...
class BookmetutorApplicationTests {
    ...
    fun `Test For TutorRepo`() {
        ...
        assertAll({
            ...
            assertEquals("FIND SUITABLE M1 SUCCESS", updatedTutor, tutorRepo.findTutorForAssignment("ROURKELA", rejects = emptyList()))
            assertEquals("FIND SUITABLE M1 FAILURE", maleTutor2, tutorRepo.findTutorForAssignment("ROURKELA", rejects = listOf(updatedTutor.email, femaleTutor1.email)))
