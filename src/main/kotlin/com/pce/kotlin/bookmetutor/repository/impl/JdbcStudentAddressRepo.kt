...
import com.pce.kotlin.bookmetutor.repository.mapper.StudentAddressRowMapper
...
class JdbcStudentAddressRepo(val jdbcTemplate: NamedParameterJdbcTemplate, val studentAddressRowMapper: StudentAddressRowMapper) : StudentAddressRepo {
